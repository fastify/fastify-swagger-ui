...
#### Options
 ...
 | uiConfig             | {}               | Configuration options for [Swagger UI](https://github.com/swagger-api/swagger-ui/blob/master/docs/usage/configuration.md). Functions should be self contained, as variables outside the functions will not work. You can access the swagger-ui element with `ui` as it is assigned to `window.ui`.                                                                                                   |
