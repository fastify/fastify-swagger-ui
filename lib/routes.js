...
function fastifySwagger (fastify, opts, done) {
  ...
  fastify.route({
    ...
    handler: hasTransformSwaggerFn
      ? function (req, reply) {
        reply.send(transformSwagger(req, reply, JSON.parse(JSON.stringify(fastify.swagger()))))
      }
      : function (req, reply) {
    ...
    handler: hasTransformSwaggerFn
      ? function (req, reply) {
        reply
          ...
          .send(yaml.stringify(transformSwagger(req, reply, JSON.parse(JSON.stringify(fastify.swagger())))))
      }
      : function (req, reply) {
        reply
          .type('application/x-yaml')
