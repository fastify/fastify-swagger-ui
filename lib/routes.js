...
function fastifySwagger (fastify, opts, done) {
  ...
  fastify.route({
    ...
    handler: hasTransformSwaggerFn
      ? function (req, reply) {
        reply.send(transformSwagger(JSON.parse(JSON.stringify(fastify.swagger()), req, reply)))
      }
      : function (req, reply) {
    ...
    handler: hasTransformSwaggerFn
      ? function (req, reply) {
        reply
          ...
          .send(yaml.stringify(transformSwagger(JSON.parse(JSON.stringify(fastify.swagger())), req, reply)))
      }
      : function (req, reply) {
        reply
          .type('application/x-yaml')
